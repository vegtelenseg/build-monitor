...
export const healthStatusActions = {
    healthStatusAction: healthStatus =>
        createaAction(blockActionTypes.SET_HEALTH_STATUS, healthStatus),
    previousHealthStatusAction: prevHealthStatus =>
        createaAction(blockActionTypes.SET_PREV_HEALTH_STATUS, prevHealthStatus),
